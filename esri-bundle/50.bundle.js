(window.webpackJsonp = window.webpackJsonp || []).push([
  [50],
  {
              ...
              return (
                ...
                (e.prototype._peekByScaleFirst = function(e) {
                  ...
                  for (
                    ...
                    var h = u[a],
                      c = this._keysToRequests.get(h),
                      l = this.tileInfoView.getTileScale(c.key);
                    o.has(l) ||
                      (o.set(l, []),
                      (i = Math.max(l, i)),
                      (r = Math.min(l, r))),
                  ...
                  o.has(d) ||
                    ...
                    s.sort(),
                    (d = s.reduce(function(e, t, i, r) {
                      return Math.abs(t - d) < Math.abs(e - d) ? t : e;
                    }, s[0]))),
                    (d = Math.min(d, i)),
                    (d = Math.max(d, r));
                  var p = o.get(d),
                    f = t.getClosestInfoForScale(d),
                    _ = f.getColumnForX(this.state.center[0]),
                  ...
                  return (
                    p.sort(function(e, t) {
                      ...
                      return (
                        Math.sqrt(
                          (_ - i) * (_ - i) + (g - e.row) * (g - e.row)
                        ) -
                        Math.sqrt((_ - r) * (_ - r) + (g - t.row) * (g - t.row))
                      );
                    }),
                    n.clear(),
                    o.clear(),
                ...
                (e.prototype.update = function(e) {
                  ...
                  if (n) {
                    var c = n.spans,
                      l = n.lodInfo,
                      d = l.level,
                      p = e.state.resolution,
                      f = !e.stationary && p > this._previousResolution;
                    (this._previousResolution = p),
                      ...
                      for (var y = 0, v = c; y < v.length; y++)
                        for (
                          ...
                          var T = o.set(
                            ...
                            m,
                            l.normalizeCol(w),
                            l.getWorldForColumn(w)
                          ).id;
                          if (i.has(T)) {
                            if (
                              ((q = i.get(T)).status !==
                                r.TileStatus.INITIALIZED && g++,
                              q.attached)
                            ) {
                              a.set(T, q);
                              continue;
                            }
                            q.attached || f || this._addParentTile(T, a);
                          } else {
                            var q = this.acquireTile(o);
                            this.tileIndex.set(T, q),
                              f || this._addParentTile(T, a);
                          }
                        }
                    var P = g === _;
                    (h.length = 0),
                    ...
                    for (var k = 0, S = h; k < S.length; k++) {
                      T = S[k];
                      (q = i.get(T)) && q.attached && a.set(T, q);
                    }
                    for (var M = 0, R = u; M < R.length; M++) {
                      (T = R[M]), (q = i.get(T));
                      this.releaseTile(q), s(i, T);
                    }
                ...
                if (e && e.length) {
                  for (
                    var i = this.objectIdField,
                      ...
                      n = this._oldIndex,
                      s = this._createIndexById(e, i),
                      o = this._extractObjectIds(s),
                      a = this._extractObjectIds(r),
                      u = this._extractObjectIds(n),
                      h = a.concat(u),
                      c = [],
                      l = h.length,
                      d = 0;
                    ...
                    var p = h[d];
                    o.indexOf(p) > -1 && c.push(p);
                  }
                  c.length && this._remove(c, !1);
                  var f = this.findIntent(t),
                    _ = new Map(),
                    g = e.length;
                  for (d = 0; d < g; d++) {
                    var y = e[d];
                    y && y.attributes && _.set(y.attributes[i], f);
                  }
                  e.length && this._add(e, _);
                }
              },
              remove: function(e) {
                this._remove(e, !1);
              ...
              update: function(e, t) {
                if (e && e.length) {
                  for (
                    ...
                    var p = h[d];
                    if (-1 === o.indexOf(p)) c.push(p);
                    else {
                      var f = r.get(p) || n.get(p),
                        _ = f && f.graphic && f.graphic._ts,
                        g = s.get(p);
                      (g && g.graphic && g.graphic._ts) > _ && c.push(p);
                    }
                  }
                  var y = [],
                    v = o.length;
                  for (d = 0; d < v; d++) {
                    p = o[d];
                    (-1 === h.indexOf(p) || c.indexOf(p) > -1) && y.push(p);
                  }
                  c.length && this._remove(c, !1),
                    y.length && this._add(this._extractGraphics(y, s), t);
                }
              },
              _createIndexById: function(e, t) {
                ...
                if (e && e.length && t)
                  for (i = new Map(), r = 0; (n = e[r]); r++)
                    null != (s = n.attributes && n.attributes[t]) &&
                      i.set(s, { graphic: n, refCount: 1 });
                return i;
              },
              _add: function(e, t) {
                var i = this.objectIdField;
      ...
      (r = [
        ...
        void 0 ===
          (n = function(
            ...
            var x = u.getLogger("esri.views.2d.layers.MapImageLayerView2D"),
              b = (function() {
                function e() {
                  (this.key = new v(0, 0, 0, 0)),
                    (this.status = g.TileStatus.INITIALIZED);
                }
            ...
            return (function(e) {
              function t(t) {
                ...
                return (
                  ...
                  (i._tileRequests = new Map()),
                  (i.layer = t.layer),
                  (i.layerView = t.layerView),
                  (i.graphics = t.graphics),
                  (i._tileInfo = _.create({
                    spatialReference: i.layerView.view.spatialReference,
                    size: 512
                  })),
                  (i._tileInfoView = new y(i._tileInfo)),
                  (i._tileQueue = new I({
                    tileInfoView: i._tileInfoView,
                    process: function(e) {
                      return i._fetchTile(e);
                    }
                  })),
                  (i._tileSet = new p({
                    layer: i.layer,
                    tileInfo: i._tileInfo
                  })),
                  (i._graphicsManager = new f({
                    graphics: i.graphics,
                    objectIdField: i.layer.objectIdField
                  })),
                  (i._tileStrategy = new m({
                    cachePolicy: "purge",
                    acquireTile: function(e) {
                      return i._acquireTile(e);
                    },
                    releaseTile: function(e) {
                      return i._releaseTile(e);
                    },
                    tileInfoView: i._tileInfoView
                  })),
                  i._handles.add(
                    [
                      i.layer.watch("outFields", function(e, t) {
                        if (e && t) {
                      ...
                      i.layer.on("edits", function(e) {
                        return i._editsHandler(e);
                      })
                    ],
                    "layer"
                  ),
              ...
              return (
                ...
                (t.prototype.destroy = function() {
                  var e = this;
                  this._pendingQueries.forEach(function(e) {
                    e.isFulfilled() || e.cancel();
                  }),
                    this._tileStrategy.tiles.forEach(function(t) {
                      return e._releaseTile(t);
                    }),
                    this._handles.destroy(),
                    this._graphicsManager.destroy(),
                  ...
                  set: function(e) {
                    ...
                    i !== e &&
                      ...
                      e &&
                        ...
                        this._handles.add(
                          [
                            e.on("after-add", function(e) {
                              (e.item.layer = t.layer),
                ...
                Object.defineProperty(t.prototype, "updating", {
                  get: function() {
                    return (
                      ...
                      this.get("_graphicsManager.updating")
                    );
                  },
                  enumerable: !0,
                  configurable: !0
                ...
                (t.prototype.update = function(e) {
                  ...
                  this._tileQueue.pause(),
                    (this._tileQueue.state = e.state),
                    this._tileStrategy.update(e);
                  var i = this.layer.objectIdField,
                    r = new Map(),
                    n = this._tileStrategy.tiles.reduce(function(e, n) {
                      if (n.featureSet) {
                        var s = t._graphicsManager.findIntent(n.intentId);
                        n.featureSet.features.forEach(function(t) {
                          t &&
                            t.attributes &&
                            (r.set(t.attributes[i], s), e.push(t));
                        });
                      }
                      return e;
                    }, []);
                  this._graphicsManager.update(n, r),
                    this._tileQueue.resume(),
                    this.notifyChange("updating");
                }),
                (t.prototype.refresh = function() {
                  var e = this;
                  this._tileQueue.reset(),
                    this._graphicsManager.removeAll(),
                    this._tileStrategy.tiles.forEach(function(t) {
                      var i = e._graphicsManager.createIntentToAdd();
                      e.notifyChange("updating");
                      var r = e._tileSet.fetch(t.key).then(function(r) {
                        return (
                          (t.intentId = i),
                          (t.featureSet = r),
                          e._graphicsManager.add(
                      ...
                      return (
                        r.always(function() {
                          e._graphicsManager.removeIntent(i),
                            e.notifyChange("updating");
                        }),
                        r
                      );
                ...
                (t.prototype._acquireTile = function(e) {
                  var t = this,
                    i = new b();
                  i.key.set(e);
                  var r = this._tileQueue.push(i.key).then(function(e) {
                    (i.status = g.TileStatus.READY),
                      (i.attached = !0),
                      (i.featureSet = e.featureSet),
                      (i.intentId = e.intentId),
                      t._graphicsManager.removeIntent(i.intentId),
                      t.layerView.requestUpdate();
                  });
                  return (
                    this._tileRequests.set(i, r),
                    this.notifyChange("updating"),
                    i
                  );
                }),
                (t.prototype._releaseTile = function(e) {
                  if (this._tileRequests.has(e)) {
                ...
                (t.prototype._fetchTile = function(e) {
                  var t = this,
                    i = this._graphicsManager.createIntentToAdd(),
                    r = this._tileSet.fetch(e).then(function(e) {
                      for (
                        var t = Date.now(), r = 0, n = e.features;
                        r < n.length;
                        r++
                      )
                        n[r]._ts = t;
                      return { featureSet: e, intentId: i };
                    });
                  return (
                    r.catch(function(e) {
                      if (
                        (t._graphicsManager.removeIntent(i),
                        e && "cancel" === e.dojoType)
                      )
                        return c.reject(e);
                      var r = new s(
                        "ondemandcontroller2d:tile-request-failed",
                        "Failed to query for features",
                        { error: e }
                      );
                      return x.error(r), c.reject(r);
                    }),
                    r
                  );
                }),
                (t.prototype._editsHandler = function(e) {
                  var t = this,
                    ...
                    r = e.deletedFeatures.map(i);
                  this._graphicsManager.delete(r);
                  var n = e.addedFeatures.concat(e.updatedFeatures).map(i);
                  if (n.length) {
                    var s = this.layer.createQuery();
                    (s.objectIds = n),
                      (s.outSpatialReference = this._tileInfo.spatialReference);
                    var o = this._graphicsManager.createIntentToAdd(n),
                      a = this.layer.queryFeatures(s);
                    this._pendingQueries.set(o, a),
                      this.notifyChange("updating"),
                      a
                        .then(function(e) {
                          return t._refetchHandler(e, o);
                        })
                        .always(function() {
                          t._graphicsManager.removeIntent(o),
                            t._pendingQueries.delete(o),
                            t.notifyChange("updating");
                        });
                  }
                }),
                (t.prototype._refetchHandler = function(e, t) {
                  var i = this,
                    r = e.features;
                  if (r) {
                    for (
                      var n = this._tileInfo.spatialReference,
                        s = 0,
                        o = this._tileStrategy.tiles;
                      s < o.length;
                      s++
                    ) {
                      !(function(e) {
                        ...
                        r.forEach(function(t) {
                          t.geometry &&
                            s.intersects(t.geometry) &&
                            i._addFeatureToTile(t, e);
                        });
                      })(o[s]);
                    }
                    this._graphicsManager.add(r, t);
                  }
                }),
                (t.prototype._addFeatureToTile = function(e, t) {
                  var i,
                    r = t.featureSet.features || [],
                    n = this.layer.objectIdField,
                    s = e.attributes && e.attributes[n];
                  r.some(function(e) {
                    return (
                      (e.attributes && e.attributes[n]) === s && (i = e), !!i
                    );
                  }),
                    i
                      ? ((i.geometry = e.geometry),
                        (i.attributes = e.attributes))
                      : r.push(e),
                    (t.featureSet.features = r);
                }),
                r([l.property()], t.prototype, "graphics", null),
                r([l.property()], t.prototype, "layer", void 0),
                r([l.property()], t.prototype, "layerView", void 0),
                r([l.property()], t.prototype, "updating", null),
                r(
                  [
                    l.subclass(
    ...
    2295: function(e, t, i) {
      var r, n;
      (r = [i.dj.c(e.i), t, i(35), i(778)]),
        void 0 ===
          (n = function(e, t, i, r) {
            return (function() {
              function e(e) {
                (this.layer = e.layer), (this.tileInfo = e.tileInfo);
              }
              return (
                (e.prototype.fetch = function(e) {
                  return this._queryTile(e);
                }),
                (e.prototype._queryTile = function(e) {
                  return this.layer.queryFeatures(this._createQuery(e));
                }),
                (e.prototype._createQuery = function(e) {
                  this.tileInfo.updateTileInfo(e);
                  var t = this.tileInfo.spatialReference,
                    r = this.layer.createQuery();
                  return (
                    (r.geometry = i.toExtent(e.extent, t)),
                    (r.outSpatialReference = t),
                    this._setResolutionParams(r, e),
                    r
                  );
                }),
                (e.prototype._setResolutionParams = function(e, t) {
                  var i = this.layer,
                    n = i.geometryType;
                  if ("polyline" === n || "polygon" === n) {
                    var s = this.tileInfo.lodAt(t.level).resolution;
                    "polyline" === n && (e.maxAllowableOffset = s),
                      i.get("capabilities.query.supportsQuantization") &&
                        (e.quantizationParameters = new r.default({
                          mode: "view",
  ...
  (function() {
    (this || window).webpackJsonp.registerAbsMids({
      ...
      "esri/layers/graphics/controllers/OnDemandController2D": 2294,
      "esri/layers/graphics/controllers/support/TileSet": 2295
    });
  })();
