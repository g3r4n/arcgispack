(window.webpackJsonp = window.webpackJsonp || []).push([
  [44, 26],
  {
                ...
                return (
                  ...
                  (t.prototype._clearImage = function(e) {
                    ...
                    t &&
                      ...
                      t.texture &&
                        (r.remove(f.ModelContentType.TEXTURE, t.texture.id),
                        (t.texture = null)),
                      t.material &&
                        (r.remove(f.ModelContentType.MATERIAL, t.material.id),
                        (t.material = null)),
                      t.loadingPromise &&
                  ...
                  (t.prototype._createStageObjects = function(e, t) {
                    ...
                    t &&
                      (a.texture &&
                        r.remove(f.ModelContentType.TEXTURE, a.texture.id),
                      (a.texture = new m(t, "dynamicLayer", {
                        width: t.width,
                        height: t.height,
                        wrapClamp: !0
                      })),
                      r.add(f.ModelContentType.TEXTURE, a.texture)),
                      a.material
                        ? t &&
                        ...
                        : ((a.material = new v(
                          ...
                          r.add(f.ModelContentType.MATERIAL, a.material));
                    var n,
                  ...
                  (t.prototype._extentAndSizeAtResolution = function(e, t, r) {
                    ...
                    var n = this._clippedExtent(e, t, S);
                    return (
                      (a.width = Math.round(
    ...
    1999: function(e, t, r) {
      var i, a;
      (i = [r.dj.c(e.i), t, r(5), r(0), r(1), r(20), r(798), r(1962)]),
        void 0 ===
          (a = function(e, t, r, i, a, n, o, s) {
            return (function(e) {
              function t() {
              ...
              return (
                ...
                (t.prototype.initialize = function() {
                  var e = this;
                  (this._exportWMSImageParameters = new o({
                    layer: this.layer
                  })),
                    this._handles.add(
                      this._exportWMSImageParameters.watch("version", function(
                        t
                      ) {
                        e._imageVersion !== t &&
                ...
                (t.prototype.destroy = function() {
                  this._exportWMSImageParameters &&
                    ((this._exportWMSImageParameters.layer = null),
                    this._exportWMSImageParameters.destroy(),
                    (this._exportWMSImageParameters = null));
                }),
                (t.prototype.beforeFetch = function() {
                  this._imageVersion = this._exportWMSImageParameters.version;
                }),
                (t.prototype.getPopupData = function(e) {
                  var t = e.center,
                    r = this.findExtentInfoAt(t);
                  if (r) {
                    var i = r.extent,
                      a = new n(i[0], i[1], i[2], i[3], r.spatialReference),
                      o = r.imageSize,
                      s = o.width,
                      l = o.height,
                      d = a.width / s,
                      p = Math.round((t.x - a.xmin) / d),
                      h = Math.round((a.ymax - t.y) / d),
                      u = this.layer.fetchFeatureInfo(a, s, l, p, h);
                    if (u)
                ...
                i([a.subclass("esri.views.3d.layers.WMSLayerView3D")], t)
              );
            })(a.declared(s));
          }.apply(null, i)) || (e.exports = a);
    },
              ...
              (t.createOuterImageGeometry = function(e, t, a) {
                ...
                for (
                  var l = [
                    ...
                    c = l[0] > 0 && l[2] > 0 ? 3 : 2,
                    y = (c + 1) * (u + 1),
                    f = new Float32Array(3 * y),
                    g = new Float32Array(2 * y),
                ...
                var L = {};
                (L[n.VertexAttrConstants.POSITION] = { size: 3, data: f }),
                  (L[n.VertexAttrConstants.NORMAL] = { size: 3, data: s }),
                  (L[n.VertexAttrConstants.UV0] = { size: 2, data: g });
                for (
                  var P = {}, D = new Uint32Array(m.length), E = 0;
                  E < D.length;
                  E++
                )
                  D[E] = 0;
                return (
                  (P[n.VertexAttrConstants.POSITION] = m),
                  (P[n.VertexAttrConstants.NORMAL] = D),
                  (P[n.VertexAttrConstants.UV0] = m),
                  new i(L, P)
                );
              });
          }.apply(null, i)) || (e.exports = a);
  ...
  (function() {
    (this || window).webpackJsonp.registerAbsMids({
      ...
      "esri/views/3d/layers/WMSLayerView3D": 1999,
