(window.webpackJsonp = window.webpackJsonp || []).push([
  [45],
  {
    2001: function(e, t, r) {
      ...
      (i = [
        ...
        void 0 ===
          (n = function(e, t, r, i, n, o, a, l, p, s, u, d) {
            var y = a.getLogger("esri.views.3d.layers.WMTSLayerView3d");
            return (function(e) {
              function t() {
                var t = (null !== e && e.apply(this, arguments)) || this;
                return (t._handles = new o()), t;
              }
              return (
                r(t, e),
                (t.prototype.initialize = function() {
                  var e = this,
                    t = p
                      .whenTrueOnce(
                        this.view,
                        "basemapTerrain.tilingSchemeDone"
                      )
                      .then(function() {
                        var t = function() {
                          return new n(
                            "layerview:no-compatible-tiling-scheme",
                            "None of the tiling schemes supported by the service are compatible with the scene."
                          );
                        };
                        if (!e.view.basemapTerrain.tilingSchemeLocked)
                          return l.reject(t());
                        var r,
                          i = e.view.basemapTerrain.tilingScheme,
                          o = e.layer.activeLayer;
                        if (o && o.tileMatrixSet) {
                          var a = (r = o.tileMatrixSet).tileInfo,
                            p =
                              e._getTileInfoSupportError(a, r.fullExtent) ||
                              e._getTileInfoCompatibilityError(a, i);
                          if (p) return l.reject(p);
                        } else {
                          if (!(r = e._getCompatibleTileMatrixSet()))
                            return l.reject(t());
                          o.tileMatrixSetId = r.id;
                        }
                        (e.tileInfo = r.tileInfo),
                          (e.fullExtent = r.fullExtent),
                          e._updateMinMaxDataLevel();
                      });
                ...
                (t.prototype.canResume = function() {
                  ...
                  var e = this.layer.activeLayer.tileMatrixSet;
                ...
                (t.prototype._initialized = function() {
                  var e = this;
                  this._handles.add(
                    this.layer.activeLayer.watch("styleId", function(t) {
                      e.refresh();
                    })
                  ),
                    this._handles.add(
                      this.layer.watch("activeLayer", function(t) {
                        var r = t.tileMatrixSet;
                        if (r) {
                          var i = e._getTileInfoError(r.tileInfo, r.fullExtent);
                          i &&
                            (y.error(
                              "The selected tile matrix set is not compatible with the view",
                              i
                            ),
                            (r = null));
                        } else (r = e._getCompatibleTileMatrixSet()) ? (t.tileMatrixSetId = r.id) : y.error("The layer does not provide a tiling scheme that is compatible with the view");
                        e.notifyChange("suspended"),
                          e.canResume() && e.refresh();
                      })
                    );
                }),
                (t.prototype._getCompatibleTileMatrixSet = function() {
                  var e = this;
                  return this.layer.activeLayer.tileMatrixSets.find(function(
                    t
                  ) {
                    var r = t.tileInfo;
                    return !e._getTileInfoError(r, t.fullExtent);
                  });
                }),
                (t.prototype._getTileInfoError = function(e, t) {
                  return (
                    this._getTileInfoSupportError(e, t) ||
                    this._getTileInfoCompatibilityError(
                      e,
                      this.view.basemapTerrain.tilingScheme
                    )
                  );
                }),
                i(
                ...
                i(
                  [s.property({ aliasOf: "layer.tileInfo" })],
                  t.prototype,
                  "tileInfo",
                  void 0
                ),
                i([s.subclass("esri.views.3d.layers.WMTSLayerView3D")], t)
              );
            })(s.declared(u, d));
  ...
  (function() {
    (this || window).webpackJsonp.registerAbsMids({
      "esri/views/3d/layers/WMTSLayerView3D": 2001,
