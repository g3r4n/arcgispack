define({
  ...
  "dojo/cldr/nls/gregorian": {
    ...
    "quarters-format-abbr": ["1. kvt.", "2. kvt.", "3. kvt.", "4. kvt."],
    ...
    "quarters-standAlone-abbr": ["1. kvt.", "2. kvt.", "3. kvt.", "4. kvt."],
    eraAbbr: ["f.Kr.", "e.Kr."],
    "field-minute": "Minut",
  ...
  "esri/nls/common": {
    ...
    all: "Alle",
    apply: "Anvend",
    auth: { logOut: "Log ud", signIn: "Log ind" },
    back: "Tilbage",
    cancel: "Annullér",
    change: "Redigér",
    clear: "Ryd",
    ...
    undo: "Fortryd",
    view: "Vis",
    visibility: { hide: "Hide", show: "Vis", toggle: "Skift" },
    warning: "Advarsel",
    _localized: {}
  }
});
