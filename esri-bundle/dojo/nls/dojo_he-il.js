define({
  ...
  "esri/nls/common": {
    ...
    all: "הכל",
    apply: "בצע",
    auth: { logOut: "התנתק", signIn: "היכנס לחשבון" },
    back: "חזור",
    cancel: "בטל",
    change: "שנה",
    clear: "נקה",
    ...
    collapse: "צמצם",
    configure: "קבע תצורה",
    control: { pause: "השהה", play: "נגן", resume: "התחל מחדש", stop: "עצור" },
    copy: "העתק",
    create: "צור",
    cut: "גזור",
    delete: "מחק",
    ...
    undo: "בטל שינויים",
    view: "תצוגה",
    visibility: { hide: "הסתר", show: "הצג", toggle: "החלף" },
    warning: "אזהרה",
    _localized: {}
  }
});
