(window.webpackJsonp = window.webpackJsonp || []).push([
  [10],
  {
    ...
    823: function(e, t, r) {
      ...
      (i = [
        ...
        void 0 ===
          (n = function(e, t, r, i, n, o, a, l, s, p) {
            return (function(e) {
              function t() {
              ...
              return (
                ...
                (t.prototype.initialize = function() {
                  var e = this,
                    t = this.get("view.map.ground.layers"),
                    r = this.get("view.map.allLayers"),
                    i = r && r.includes(this.layer),
                    l = t && t.includes(this.layer);
                  if (i && !l) {
                    var s = new n(
                      "layerview:elevation-layer-only",
                      "3D elevation layer '" +
                        this.layer.id +
                        "' can only be added in the map ground"
                    );
                    this.addResolvingPromise(o.reject(s));
                  }
                  var u = this._getTileInfoSupportError(
                    this.tileInfo,
                    this.layer.fullExtent
                  );
                  if (u) this.addResolvingPromise(o.reject(u));
                  else {
                    var d = a
                      .whenTrueOnce(
                        this.view,
                  ...
                  this.addResolvingPromise(
                    p.checkArcGISServiceVersionCompatibility(this.layer)
                  ),
                    this._updateMinMaxDataLevel();
                }),
                i(
                  [l.property({ aliasOf: "layer.fullExtent" })],
                  t.prototype,
                  "fullExtent",
                  void 0
                ),
                ...
                i(
                  [l.property({ aliasOf: "layer.tileInfo" })],
                  t.prototype,
                  "tileInfo",
                  void 0
                ),
                i([l.subclass("esri.views.3d.layers.ElevationLayerView3D")], t)
              );
            })(l.declared(s));
          }.apply(null, i)) || (e.exports = n);
    }
  ...
  (function() {
    (this || window).webpackJsonp.registerAbsMids({
      "esri/views/3d/layers/ElevationLayerView3D": 823,
